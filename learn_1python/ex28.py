...
"""
Any 'and' expression that has a 'False' is automatically 'False'. 
Any 'or' expression that has a 'True' is automatically 'True'.
in the case with 'not', if you have 'not(True)' you invert it to 'False'.
likewise, if you have 'not(False)', you invert it to 'True'.
"""
